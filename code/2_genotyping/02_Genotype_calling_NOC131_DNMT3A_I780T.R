...
# 1. If the mutation was identified in either the gDNA or cDNA amplicon, the cell is called ‘mutant’.
...
# 4. If the cDNA amplicon was WT but the gDNA amplicon was undetected or undetermined, the cell is called ‘undetermined’,
